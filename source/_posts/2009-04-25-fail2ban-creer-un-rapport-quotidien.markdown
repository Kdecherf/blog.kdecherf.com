...
layout: post
slug: fail2ban-creer-un-rapport-quotidien
status: publish
...
Après l'article pour [transformer les mails Fail2ban façon Nagios](http://blog.kdecherf.com/2009/03/27/fail2ban-email-alerte-facon-nagios/), voici un petit article pour générer des rapports journaliers de l'activité de votre chien de garde favori.

![fail2ban_logo](http://blog.kdecherf.com/wp-content/uploads/2009/04/fail2ban_logo.png)
...
[bash]10 0 * * *      /etc/fail2ban/action.d/report.sh > /dev/null[/bash]

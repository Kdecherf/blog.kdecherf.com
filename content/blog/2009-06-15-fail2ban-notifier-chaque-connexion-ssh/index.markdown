...
Le formatage des mails utilisé ici est disponible [sur ce billet]({{< ref "/blog/2009-03-27-fail2ban-email-alerte-facon-nagios/index.markdown" >}}).
...
![ssh-fail2ban-notify](ssh-fail2ban-notify.png)
